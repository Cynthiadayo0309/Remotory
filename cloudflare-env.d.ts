/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=preview --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 7dcf272f992023ee18fd95030b5bfc17)
...
interface __BaseEnv_CloudflareEnv {
	...
	COMPANY_UPDATE_WORKFLOW: Workflow<Parameters<import("./worker").CompanyUpdateWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REMOTORY_AUTH_DEV_BYPASS" | "REMOTORY_ENABLE_REMOTE_BINDINGS" | "REMOTORY_SITE_URL" | "REMOTORY_ALLOW_INDEXING" | "CLOUDFLARE_ACCESS_TEAM_DOMAIN" | "CLOUDFLARE_ACCESS_AUD" | "REMOTORY_ADMIN_EMAIL">> {}
}
